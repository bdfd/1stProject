...
function generateStuffInsideFences(data) {
  ...
  <ul>
  ${renderedList}
  <li><a href="https://github.com/bdfd/1stProject/issues/new?assignees=&labels=&template=endorsement-template.md&title=Endorse%3A+SKILL_HERE">Endorse new skill!</a></li>
  </ul>
  ${END_COMMENT}`;
